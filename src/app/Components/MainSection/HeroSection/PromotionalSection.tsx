    ...
    <div className='h-[764px] bg-[#F2F0FF] flex'>
       <div className='flex flex-col gap-20'>
        ...
        <div className='text-black h-[248px] flex flex-col justify-center gap-4 mt-48  '>
            ...
            <button className={`w-[163px] h-[50px] rounded-sm  bg-[#FB2E86] p-5 flex justify-center items-center text-white font-semibold ${josefinSans.className}`}>Sign Up</button>
        </div>
